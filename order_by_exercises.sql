...
SELECT DISTINCT last_name, first_name, emp_no FROM employees WHERE last_name LIKE 'E%' ORDER BY emp_no;
-- A) Number unknown, First employee (10021 - Ramzi Erde), Last employee (51050 - Parto Egerstedt)
...
-- A) There were 363 employees returned. Oldest employee who was hired last (Bernini Khun) and the name of the youngest employee who was hired first (Pettis Douadi).
